...
namespace Fishing
{
    ...
    {
        //-------------------------------------------------------------------------
        public TaskType TaskType { get; private set; }// 任务类型
        public TaskCategory TaskCategory { get; private set; }// 任务分类
        ...
        {
            TaskType = (TaskType)prop_set.getPropInt("I_TaskType").get();
            TaskCategory = (TaskCategory)prop_set.getPropInt("I_TaskCategory").get();
