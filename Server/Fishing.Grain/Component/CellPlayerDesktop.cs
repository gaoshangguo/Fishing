...
namespace Fishing
{
    ...
    internal class CellPlayerDesktopConsumerObserver<StreamData> : IAsyncObserver<Fishing.StreamData>
    {
        //---------------------------------------------------------------------
        ...
        //---------------------------------------------------------------------
        public Task OnNextAsync(Fishing.StreamData item, StreamSequenceToken token = null)
        {
